...
public class OTP extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            drawables[0].setColorFilter(getResources().getColor(R.color.material_green_convergence), PorterDuff.Mode.SRC_IN);
            drawables[1].setColorFilter(getResources().getColor(R.color.material_green_convergence), PorterDuff.Mode.SRC_IN);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mNumChars; i++) {
            ...
            if (getText().length() > i) {
                ...
                paint.setColor(getResources().getColor(R.color.material_green_convergence));
    ...
    private void updateColorForLines(boolean next) {
        if (isFocused()) {
            ...
            mLinesPaint.setColor(getResources().getColor(R.color.material_green_convergence));
            if (next) {
