package in.ac.vnrvjiet.convergence.presentation.util.bottombar;
...
public class BottomBar extends LinearLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void populateAttributes(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        try {
            ...
            @ColorInt
            int defaultInActiveColor = ContextCompat.getColor(context, R.color.bb_inActiveBottomBarItemColor);

            int defaultActiveColor = getResources().getColor(R.color.material_green_convergence);
    ...
    private boolean handleLongClick(BottomBarTab longClickedTab) {
        boolean areInactiveTitlesHidden = isShiftingMode();
    ...
    private void handleBackgroundColorChange(BottomBarTab tab, boolean animate) {
        ...
        animateBGColorChange(tab, newColor);
